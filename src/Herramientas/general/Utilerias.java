...
public class Utilerias {
    ...
    /**
     * Este m̩todo compara dos objetos sean del tipo que sean.
    ...
    public static int compararObjetos(Object objeto1, Object objeto2){
        ...
        }else{ // cuando no sean n̼meros, es decir, Personas, Muebles, Cadenas, en otros.
            //me voy a apoyar en el m̩todo toString()
